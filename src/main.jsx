...
const DEFAULT_BOOKS = [
  ...
  },
  {
    ...
    storySentences: [
      "빵집 아저씨의 가게에는 달콤하고 고소한 빵 냄새가 가득했어요.",
      "코가 간지럽던 빵집 아저씨가 입을 가리지 않고 크게 재채기했어요.",
      "감기 바이러스는 침방울을 타고 빵과 손 위에 내려앉았어요.",
      "엄마는 빵을 먹은 뒤 서둘러 집으로 돌아갔어요.",
      "유치원에서 온 {hero:를} 반갑게 안고 얼굴을 맞댔어요.",
      "{hero:는} 손을 씻지 않고 놀다가 코를 만지고 밥을 먹었어요.",
      "늦게까지 놀던 {hero:는} 다음 날 열이 나고 콧물이 났어요.",
      "{hero:는} 손을 깨끗이 씻고 재채기는 팔꿈치로 가리는 습관을 배웠어요.",
    ],
  ...
  },
  {
    ...
    age: "4–9세",
    minutes: 13,
    desc: "자전거를 갖고 싶은 {hero:가} 용돈과 저축의 뜻을 알아 가며 기다리는 힘을 길러요.",
    ...
    storySentences: [
      "{hero:는} 자전거 가게에서 마음에 쏙 드는 자전거를 발견했어요.",
      "{hero:는} 엄마에게 자전거를 사 달라고 여러 번 졸랐어요.",
      "엄마는 얼마 전에 산 킥보드와 많은 장난감을 함께 살펴보았어요.",
      "자전거는 과자보다 훨씬 비싸서 돈을 많이 모아야 살 수 있었어요.",
      "엄마는 {hero}에게 용돈을 주며 저축하는 방법을 알려 주었어요.",
      "{hero:는} 로봇과 사탕과 게임에 용돈을 쓰고 빈 주머니를 발견했어요.",
      "{hero:는} 사고 싶은 것 앞에서 멈춰 생각하고 동전을 조금씩 모았어요.",
  ...
  },
  {
    ...
    age: "4–9세",
    minutes: 14,
    desc: "{hero:와} 엄마를 따라 버스·지하철·기차를 갈아타며 대중교통 이용 방법을 익혀요.",
